    ...
    return (
      <div className="bg-color">
        <div className="container">
          <h1 className="text-center mt-1">MARKSHEET LIST</h1>
          ...
          <div className="row row-cols-lg-auto g-3 align-items-center mb-4 mt-1 justify-content-center">
            ...
            <div className="col-12">
              <button
                ...
                onClick={(ev) => this.search("Marksheet")}
              >
                Search
              </button>
            </div>
              ...
              {this.state.searchList.map((ele, index) => (
                <tr>
                  ...
                  <td className="text-center">
                    {ele.physics + ele.chemistry + ele.maths}
                  </td>
                  <td className="text-center">
                  ...
                  <td className="text-center">
                    <Link to={"/Marksheet/" + ele.id} className="btn btn-light">
                      <svg
